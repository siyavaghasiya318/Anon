      ...
      <div className="fixed inset-0 bg-black/50  flex backdrop-blur-[5px] items-center justify-center z-50">
          <div className="bg-white text-gray-600 rounded-lg w-100  p-5 ">
            ...
            <form action="" onSubmit={FromSubmit} className="px-6 pt-5 flex flex-col gap-3">
              <input name='name' value={UserForm.name} onChange={Handlechange} type="text" placeholder="Name" className="border border-gray-200 rounded-sm px-4 py-1 w-full" />
              <input name='email' value={UserForm.email} onChange={Handlechange} type="email" placeholder="Email" className="border border-gray-200 rounded-sm px-4 py-1 w-full" />
              <input type="password" name='password' value={UserForm.password} onChange={Handlechange} placeholder="Password" className="border border-gray-200 rounded-sm px-4 py-1 w-full" />

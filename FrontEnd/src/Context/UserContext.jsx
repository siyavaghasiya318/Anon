...
export const UserProvider = ({ children }) => {
    ...
    const UserAddressSubmit = async (e) => {
        ...
        try {
            ...
            const { data } = await axios.post("http://localhost:5000/api/useraddress/address", addressForm, { withCredentials: true })
            // console.log(data);
    ...
    const GetAddress = async () => {
        try {
            const { data } = await axios.get("http://localhost:5000/api/useraddress/getaddress", { withCredentials: true })
    ...
    const RemoveAddress = async (addressid) => {
        try {
            const { data } = await axios.delete("http://localhost:5000/api/useraddress/delete", { data: { addressid }, withCredentials: true })
            // console.log(data);
            if (data.success) {
                GetAddress();
    ...
    const ProductSubmit = async (e) => {
        ...
        try {
            ...
            const { data } = await axios.post("http://localhost:5000/api/product/addproduct", ProductData, { withCredentials: true })
            if (data.success) {
                toast.success(data.message)
    ...
    const GetProducts = async () => {
        try {
            const { data } = await axios.get("http://localhost:5000/api/product/getproducts", { withCredentials: true })
    ...
    const UpdateUser = async (item) => {
        try {
            const { data } = await axios.put("http://localhost:5000/api/user/updateuser", { withCredentials: true })
            // console.log(data);
            SetUserForm({
                name: item.name,
                email: item.email,
    ...
    const Userdelete = async (item) => {
        try {
            const { data } = await axios.delete("http://localhost:5000/api/user/deleteuser", { withCredentials: true })
            // console.log(data);
    ...
    const SellerSubmit = async (e) => {
        ...
        try {
            ...
            const { data } = await axios.post("http://localhost:5000/api/seller/registerseller", Seller, { withCredentials: true })
    ...
    const GetSellerdetails = async () => {
        try {
            const { data } = await axios.get("http://localhost:5000/api/seller/getseller", { withCredentials: true })
    ...
    const GetAllUsers = async () => {
        try {
            const { data } = await axios.get("http://localhost:5000/api/user/getusers", { withCredentials: true })
    ...
    const GetAllSellers = async () => {
        try {
            const { data } = await axios.get("http://localhost:5000/api/user/getsellers", { withCredentials: true })
    ...
    const GetMyOrderItem = async () => {
        try {
            const { data } = await axios.get("http://localhost:5000/api/order/myorders", { withCredentials: true })
    ...
    const GetAllOrders = async () => {
        try {
            const { data } = await axios.get("http://localhost:5000/api/order/getorder", { withCredentials: true })
    ...
    const UpdateOrderStatus = async (orderid, orderstatus) => {
        try {
            const { data } = await axios.put("http://localhost:5000/api/order/update", { orderid, orderstatus }, { withCredentials: true })
            if (data.success) {
                GetAllOrders()
            }
        } catch (error) {
    ...
    const GetSellerProducts = async () => {
        try {
            const { data } = await axios.get("http://localhost:5000/api/product/products", { withCredentials: true })
